        ...
        <CardContent className="space-y-8">
          ...
          <div className="p-4 border bg-secondary/50 rounded-lg space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Quickly create a test by pasting all your questions and instructions into a single text box. Submissions will be sent to your email.
            </p>
            <Textarea
              rows={10}
            ...
            />
             <div className="space-y-2">
                <Label htmlFor="submission-email">Email for Receiving Submissions</Label>
                <Input
                id="submission-email"
                type="email"
          ...
          <div className="p-4 border bg-secondary/50 rounded-lg space-y-4">
            <h3 className="font-semibold">Option 2: Structured Test</h3>
             <p className="text-sm text-muted-foreground">
              Add questions one by one. Submissions will be viewable within the app in the 'View Submissions' section.
            </p>

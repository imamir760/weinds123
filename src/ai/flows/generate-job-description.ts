...
const GenerateJobDescriptionOutputSchema = z.object({
  ...
  responsibilities: z.string().describe('The responsibilities of the job as a newline-separated list. It should contain at least 5 points.'),
...
- Job Title
- Key Responsibilities (as a newline-separated string, with at least 5 distinct points)
